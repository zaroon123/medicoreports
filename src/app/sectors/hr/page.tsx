...
import faqData from '@/data/json/faq/faq-hr.json';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/components/ui/accordion';


export const metadata: Metadata = {
  ...defaultMetadata,
  title: 'Medicoreports - HR Sector',
};
...
const data = [
  {
    id: 1,
    icon: 'ns-shape-13',
    title: 'Employee-Centred Communication',
    description: 'All interactions linked to individual employee records.',
  },
  {
    id: 2,
    icon: 'ns-shape-41',
    title: 'Meeting & Review Scheduling',
    description: 'Manage onboarding sessions, reviews, and follow-ups in one place.',
  },
  {
    id: 3,
    icon: 'ns-shape-36',
    title: 'Task & Process Tracking',
    description: 'Track actions, responsibilities, and outcomes across HR workflows.',
  },
  {
    id: 4,
    icon: 'ns-shape-35',
    title: 'Built-In Workflow Structure',
    description: 'Standardise onboarding, investigations, and lifecycle processes.',
  },

  {
    ...
    description: 'Monitor employee cases, progress, and workload in real time.',
  },
  {
    id: 6,
    icon: 'ns-shape-30',
    title: 'Secure Data Handling',
    description: 'Role-based access, audit logs, and secure handling of sensitive HR data.',
  },
];
...
const eligibilityData = [
  {
    id: 1,
    text: 'Tamper-evident HR records',
  },
  {
    id: 2,
    text: 'Verifiable documentation for disputes',
  },
  {
    id: 3,
    text: 'Full traceability across employee lifecycle',
  },
];
            ...
            <div className="flex 2xl:gap-[100px] flex-col sm:flex-row h-[396px]">
              ...
              <div className="lg:max-w-[570px] xl:max-w-[595px] md:w-full text-center lg:text-left">
                <RevealAnimation delay={0.1}>
                  <span className="badge badge-white mb-5">Human resources documentation platform</span>
                </RevealAnimation>

                <RevealAnimation delay={0.2}>
                  <h1 className="text-5xl sm:text-5xl lg:text-[3.8rem]">Create consistent, defensible HR documentation without manual drafting</h1>
                </RevealAnimation>

                <RevealAnimation delay={0.3}>
                  <p className="mb-10 md:mb-14 lg:max-w-[440px] xl:max-w-[570px]">
                    Capture onboarding discussions, investigations, and employee interactions, and convert them into structured, compliant documentation with consistent formatting, traceability, and readiness for review.
                  </p>
                </RevealAnimation>
            ...
            <div className="flex lg:items-end items-center lg:flex-row flex-col lg:gap-0 gap-4 justify-between mb-[70px]">
              <div className="flex-1 lg:text-left text-center">
                <div className="space-y-3">
                  ...
                  <RevealAnimation delay={0.2}>
                    <h2 className="max-w-[518px]">How Medqon is used across HR workflows</h2>
                  </RevealAnimation>
                </div>
              </div>
              <div className="flex-1 lg:text-left text-center">
                <div>
                  <RevealAnimation delay={0.3}>
                    <p className="max-w-[518px] lg:mx-0 mx-auto">
                      Medqon structures documentation across onboarding, investigations, and employee lifecycle processes—reducing manual effort while improving consistency, compliance, and defensibility.
                    </p>
                  </RevealAnimation>
                </div>
              </div>
                ...
                <div className="col-span-12 lg:col-span-4">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-1 lg:text-left text-center">
                      <h3 className="text-heading-5">Employee Onboarding Documentation</h3>
                      <p className="max-w-[337px] lg:mx-0 mx-auto line-clamp-3">Capture onboarding discussions and automatically generate structured employee records, role summaries, and compliance documentation.</p>
                    </div>
              ...
              <RevealAnimation delay={0.6}>
                <div className="col-span-12 lg:col-span-4">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-1 lg:text-left text-center">
                      <h3 className="text-heading-5">Disciplinary & Grievance Documentation</h3>
                      <p className="max-w-[337px] lg:mx-0 mx-auto line-clamp-3">Convert meetings, interviews, and case discussions into structured, defensible records aligned with HR and legal standards.</p>
                    </div>
                    <div className="lg:text-left text-center">
                      <LinkButton
                        href={`/contact-us`}
              ...
              <RevealAnimation delay={0.4}>
                <div className="col-span-12 lg:col-span-4">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-1 lg:text-left text-center">
                      <h3 className="text-heading-5">HR Investigations</h3>
                      <p className="max-w-[337px] lg:mx-0 mx-auto line-clamp-3">Structure multi-party interviews, evidence, and findings into clear, consistent investigation reports.</p>
                    </div>
                    <div className="lg:text-left text-center">
                      <LinkButton
                        href={`/contact-us`}
              ...
              <RevealAnimation delay={0.4}>
                <div className="col-span-12 lg:col-span-4">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-1 lg:text-left text-center">
                      <h3 className="text-heading-5">Performance Reviews & Appraisals</h3>
                      <p className="max-w-[337px] lg:mx-0 mx-auto line-clamp-3">Generate structured summaries of employee reviews, feedback, and development plans.</p>
                    </div>
                    <div className="lg:text-left text-center">
                      <LinkButton
                        href={`/contact-us`}
              ...
              <RevealAnimation delay={0.4}>
                <div className="col-span-12 lg:col-span-4">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-1 lg:text-left text-center">
                      <h3 className="text-heading-5">Exit Interviews & Termination Records</h3>
                      <p className="max-w-[337px] lg:mx-0 mx-auto line-clamp-3">Capture exit discussions and produce structured, traceable documentation for final records.</p>
                    </div>
                    <div className="lg:text-left text-center">
                      <LinkButton
                        href={`/contact-us`}
                    ...
                    <div className="space-y-3 mb-8">
                      <RevealAnimation delay={0.3}>
                        <h2 className="max-w-[592px] mx-auto lg:mx-0">
                          HR documentation, structured as you work
                        </h2>
                      </RevealAnimation>
                      <RevealAnimation delay={0.4}>
                        <p>
                          Medqon captures employee interactions, extracts key information, and generates structured documentation with built-in validation and consistency checks.
                        </p>
                      </RevealAnimation>
                    </div>
                  </div>
                    ...
                    <RevealAnimation delay={0.5}>
                      <div className="sm:max-w-[596px] lg:mx-0 mx-auto sm:py-6 py-5 sm:px-[34px] px-7 bg-background-3 dark:bg-background-7 sm:rounded-[20px] rounded-2xl flex items-start sm:gap-[22px] gap-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <p>
                             Record interviews, meetings, and employee discussions.
                          </p>
                        </div>
                      </div>
                    </RevealAnimation>
                    <RevealAnimation delay={0.6}>
                      <div className="sm:max-w-[596px] lg:mx-0 mx-auto sm:py-6 py-5 sm:px-[34px] px-7 bg-background-3 dark:bg-background-7 sm:rounded-[20px] rounded-2xl flex items-start sm:gap-[22px] gap-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <p>
                             Automatically generate standardised HR documents aligned with internal and regulatory requirements.
                          </p>
                        </div>
                      </div>
                    </RevealAnimation>
            ...
            <div className="grid grid-cols-12 lg:gap-x-0 xl:gap-x-28 gap-y-12 items-center">
              <div className="col-span-12 lg:col-span-6">
                <div className="space-y-3">
                  ...
                  <RevealAnimation delay={0.3}>
                    <h2>Know if an employee record has been altered</h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.4}>
                    <p>
                      Every document includes a verifiable digital fingerprint and audit trail. Any modification after creation is immediately detectable, supporting compliance, dispute resolution, and accountability.
                    </p>
                  </RevealAnimation>
            ...
            <div className="pt-16 md:pt-[100px] max-lg:pb-10 px-5 sm:px-7 md:px-14 relative rounded-4xl bg-white overflow-hidden dark:bg-background-8">
              ...
              <div className="space-y-[70px]">
                ...
                <div className="space-y-[20px] text-center md:text-left">
                  <RevealAnimation delay={0.2}>
                    <span className="badge badge-yellow">Unified HR Workflow</span>
                  </RevealAnimation>
                  <div className="space-y-3">
                    <RevealAnimation delay={0.3}>
                      <h2>Everything connected to the employee, from onboarding to exit </h2>
                    </RevealAnimation>
                    <RevealAnimation delay={0.4}>
                      <p>Medqon connects communication, documentation, scheduling, and task tracking into a single structured system—ensuring consistency and accountability across HR processes.</p>
                    </RevealAnimation>
                  </div>
                </div>
                {/* content  */}
            ...
            <div className="grid grid-cols-12 lg:gap-x-0 xl:gap-x-28 gap-y-12 items-center">
              <div className="col-span-12 lg:col-span-6">
                <div className="space-y-3">
                  ...
                  <RevealAnimation delay={0.3}>
                    <h2>Works with your existing HR systems</h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.4}>
                    <p>
                      Medqon integrates via API with your existing HR, payroll, and internal systems.
                    </p>
                  </RevealAnimation>
                  <RevealAnimation delay={0.4}>
                    <p>
            ...
            <div className="mb-14 space-y-3 text-center md:mb-[70px]">
              ...
              <RevealAnimation delay={0.3}>
                <p className="mx-auto lg:max-w-[620px]">
                  Answers to common questions about how Medqon supports HR processes while working alongside your existing systems.
                </p>
              </RevealAnimation>
            </div>
          </div>
