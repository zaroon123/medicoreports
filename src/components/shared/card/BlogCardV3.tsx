// src/components/shared/card/BlogCardV3.tsx (Updated)
...
const BlogCardV3 = ({ blog, className }: BlogCardV3Props) => {
  ...
  const blurDataUrl = 'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjk2IiBoZWlnaHQ9IjMwOCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjZjJmMmYyIi8+PC9zdmc+';
