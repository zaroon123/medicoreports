...
const Testimonial = () => {
  return (
    <section className="pt-[100px] xl:pb-[200px] pb-[100px] bg-background-3 dark:bg-background-5">
            ...
            <div className="flex  gap-x-5 lg:gap-x-10 items-center ">
              {testimonials.map((testimonial) => {
                return (
                  <article
                    key={testimonial.id}
                    className="bg-background-2 dark:bg-background-6 rounded-[12px] lg:rounded-[20px] min-w-[320px] sm:min-w-[400px] cursor-pointer lg:min-w-[722px] space-y-6 lg:space-y-10 p-5 lg:p-14 backdrop-blur-[22px] relative group transition-all duration-500 ease-in-out hover:bg-secondary hover:dark:bg-background-8 overflow-hidden first:ml-10">
                    {/* gradient */}
