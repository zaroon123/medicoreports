    ...
    <section className="lg:pt-[180px] pt-[120px] lg:pb-[100px] pb-[70px]">
      <div className="main-container">
        <RevealAnimation delay={0.1}>
          <div className="max-w-[866px] w-full mx-auto overflow-hidden sm:bg-[url('/images/authentication/auth-bg.jpg')] bg-cover bg-center bg-no-repeat md:rounded-4xl rounded-[20px] sm:p-[70px]">
            <RevealAnimation delay={0.1}>
